...
public class racket : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        Debug.Log(dir);
        other.GetComponent<Rigidbody>().velocity =  dir.normalized * 6 + new Vector3(0, 4, 0);  //new Vector3(transform.rotation.eulerAngles.x, transform.rotation.eulerAngles.y, transform.rotation.eulerAngles.z) * 13 +
        Debug.Log("Collision");
